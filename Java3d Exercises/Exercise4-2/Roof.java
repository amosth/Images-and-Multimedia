...
public class Roof extends Group {
	...
	public Roof() {
		...
		trabeazioneTranslation.setTranslation(new Vector3d(0f, 12.6f, 0f));
		...
		frontoneTranslation.setTranslation(new Vector3d(0.0f, 14.6f, 0.0f));
		...
		spiovente1Translation.setTranslation(new Vector3d(-7.5f, 16.7f, 0f));
		...
		spiovente2Translation.setTranslation(new Vector3d(7.5f, 16.7f, 0f));
